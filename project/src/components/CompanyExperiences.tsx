  ...
  const companies = [
    {
      ...
      period: "2024-2025",
      logo: PGW,
      image: "https://i.ytimg.com/vi/DwnXbfYhoyg/maxresdefault.jpg",
      size: "108 employés",
      ...
      missions: [
        "J'intégrais des sites en marque blanche pour des clients comme Lidl et Veepee. J'étais responsable de l'adaptation responsive des interfaces, de l'application des normes RGAA et de la création des templates email sur Beefree. Lorsqu'un bug était remonté par un client, je suivais un processus de reproduction, identification de la cause, correction et test de régression avant déploiement.",
      ],
      achievements: [
        "Intégration front-end de sites marque blanche (clients : Lidl, Veepee)",
        "Responsable de l'adaptation responsive des interfaces",
        "Application et audit des normes d'accessibilité numérique (RGAA)",
        "Conception de templates email sur Beefree",
        "Mise en place du design system modulaire avec Figma",
        "Création des visuels Play Store de l'app « Bourse des Vols »",
        "Suivi des tâches sur Planio et merge requests sur GitLab",
        "Gestion des accès via Syspass (contrôle des habilitations)",
      ],
      technologies: [
        "Vue.JS",
        "SCSS",
        ...
        <Reveal>
          <div className="text-center mb-16">
            <h2 className="overflow-hidden text-5xl md:text-6xl font-bold text-gray-100 mb-6 tracking-tight -tracking-[0.02em]">
              <span className="company-title-inner inline-block translate-y-full">
                Expérience Entreprise
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Découvrez les environnements professionnels qui ont façonné mon
              expertise et les missions qui ont enrichi mon parcours de
              développeur.
            </p>
          </div>
