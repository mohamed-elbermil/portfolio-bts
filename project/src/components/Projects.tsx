  ...
  const projects = [
    {
      title: "Fitness-Area",
      description:
        "Création d'un site web moderne pour une salle de sport, mettant en avant les équipements, les cours et les abonnements disponibles.",
    ...
    },
    {
      ...
      description:
        "Il s'agit d'un projet personnel visant à automatiser la rédaction de mes descriptions de vêtements sur Vinted.",
      image: vintedImg,
        ...
        <Reveal>
          <div className="text-center mb-16">
            <h2 className="overflow-hidden text-5xl md:text-6xl font-bold text-gray-100 mb-6 tracking-tight -tracking-[0.02em]">
              <span className="projects-title-inner inline-block">
                Projets Réalisés
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed mb-8">
              Une sélection de projets qui démontrent l'étendue de mon expertise
              technique et ma capacité à créer des solutions innovantes.
            </p>
          </div>
