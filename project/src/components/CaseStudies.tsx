...
import gsbImg from "../assets/images/logo.svg";
...
const items: CaseStudy[] = [
  {
    ...
    image: moovyImg,
    problem:
      "Découvrir et organiser un catalogue de films avec une navigation rapide.",
    solution:
      "Intégration TMDB, mise en cache client, UI réactive avec React + Tailwind.",
  ...
  },
  {
    ...
    problem:
      "Présenter cours et abonnements avec une interface claire sur mobile.",
    solution:
      "Grille responsive, composants réutilisables, déploiement Vercel.",
  ...
  },
  {
    ...
    problem:
      "Suivre et valider les frais des visiteurs médicaux avec un circuit de contrôle.",
    solution:
      "Application web avec rôles, CRUD des notes de frais et workflow de validation.",
    link: "https://github.com/mohamed-elbermil/GSB2_project",
  },
];
  ...
  return (
    <section id="projets" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
        <Reveal>
          <div className="mb-12">
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight -tracking-[0.02em]">
              Études de cas
            </h2>
            <p className="mt-4 text-gray-400 max-w-2xl">
              Chaque projet structuré en “Le Problème” et “Ma Solution
              Technique”.
            </p>
          </div>
